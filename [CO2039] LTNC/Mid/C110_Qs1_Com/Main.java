...
// javac -d . Paws/CO2039_LTNC/C110_Qs1_Com/*.java
//  java Paws.CO2039_LTNC.C110_Qs1_Com.Main
public class Main {
    public static void main(String[] args) {
        ...
        Car c1 = new Car("Ford Mustang", "F88", 800);
        
        // Test Car methods
        System.out.println("Car Model: " + c1.getModel()); // Expected: Ford Mustang
        System.out.println("Car Engine Type: " + c1.getEngine().getType()); // Expected: V6
        ...
        Car c2 = new Car("Chevrolet Camaro", "V8", 500);
        
        // Test Car methods for second object
        System.out.println("Car Model: " + c2.getModel()); // Expected: Chevrolet Camaro
        System.out.println("Car Engine Type: " + c2.getEngine().getType()); // Expected: V8
        ...
        System.out.println("Updated Car Engine Type: " + c2.getEngine().getType()); // Expected: V6
    }
}
